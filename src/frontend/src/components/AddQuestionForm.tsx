...
import { type Question, QuestionState, QuestionType } from "../backend";
import {
  useAddQuestion,
  useGetDomains,
...
export function AddQuestionForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const question: Question & { evidenceUrl?: string } = {
      ...
      <div className="flex items-center space-x-3 mb-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Create a new question for the SMLE question bank
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    {options.map((option, index) => (
                      <div
                        key={`field-${option.substring(0, 20) || "empty"}`}
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={questionState}
                  onValueChange={(value) =>
                    setQuestionState(value as QuestionState)
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
        ...
        {!canCreateQuestion && (
          <Alert>
            ...
            <AlertDescription>
              Please select both a question bank and domain to continue creating
              your question.
            </AlertDescription>
          </Alert>
        )}
