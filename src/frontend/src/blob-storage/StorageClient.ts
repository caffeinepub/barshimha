...
// Local definition — the object-storage extension is not wired in this backend
export interface FileReference {
  hash: string;
  path: string;
}

// Extended actor interface for object-storage methods not in the core backendInterface
export interface StorageActorInterface extends backendInterface {
...
export class StorageClient {
  ...
  public constructor(
    private readonly actor: StorageActorInterface,
