...
import { BookOpen, Brain, TrendingUp, Users, CheckCircle, Star, Award, Clock, Target, ArrowRight, Sparkles, Zap, Shield, Trophy, Play, Pause, Volume2, VolumeX, RotateCcw, AlertCircle, Loader2, Music, Square } from 'lucide-react';
import { useState, useRef, useEffect, useCallback } from 'react';

export function LandingPage() {
  const { login, isLoggingIn } = useInternetIdentity();
  const { data: brandAssets } = useGetBrandAssets();
  ...
  const handleAudioError = (error: any) => {
    ...
    setAudioError('Audio file could not be loaded. Please check the file format.');
    setIsPlaying(false);
    setIsLoading(false);
  };
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            <div className="flex items-center justify-center mb-8">
              <div className="bg-primary/10 p-6 rounded-3xl">
                ...
                />
                <BookOpen className="h-16 w-16 text-primary" style={{ display: 'none' }} />
              </div>
            </div>
                ...
                <div className="grid lg:grid-cols-2 gap-8 items-center">
                  <div className="space-y-6 text-left">
                    <div className="flex items-center space-x-3 mb-4">
                      ...
                      <h2 className="text-2xl font-bold text-foreground">Transform Your Study Experience</h2>
                    </div>
                    
                    <p className="text-lg text-muted-foreground leading-relaxed">
                      Barshimha is a smart exam preparation platform that transforms{' '}
                      <span className="font-semibold text-primary bg-primary/10 px-2 py-1 rounded">'براشيم'</span>{' '}
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start space-x-3">
                        ...
                        <p className="text-muted-foreground">
                          <span className="font-medium text-foreground">High-quality questions</span> sourced from accredited medical references
                        </p>
                      </div>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <p className="text-muted-foreground">
                          <span className="font-medium text-foreground">Evidence-based learning methods</span> to improve recall and mastery
                        </p>
                      </div>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <p className="text-muted-foreground">
                          <span className="font-medium text-foreground">Intuitive interface</span> that makes studying smarter and more rewarding
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="bg-gradient-to-br from-primary/20 to-secondary/20 rounded-2xl p-8 border border-primary/20">
                      <div className="grid grid-cols-2 gap-4">
                        <div className="bg-card/80 backdrop-blur-sm rounded-xl p-4 text-center border border-border/50">
                          ...
                          <div className="text-xs text-muted-foreground">SMLE Domains</div>
                        </div>
                        <div className="bg-card/80 backdrop-blur-sm rounded-xl p-4 text-center border border-border/50">
                        ...
                        <div className="bg-card/80 backdrop-blur-sm rounded-xl p-4 text-center border border-border/50">
                          ...
                          <div className="text-xs text-muted-foreground">Study Modes</div>
                        </div>
                        <div className="bg-card/80 backdrop-blur-sm rounded-xl p-4 text-center border border-border/50">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <Card className="text-center hover:shadow-lg transition-all duration-300 border-2 hover:border-primary/20">
              ...
              <CardContent>
                <CardDescription className="text-base leading-relaxed">
                  Practice, timed, and review modes with detailed explanations and immediate feedback 
            ...
            <Card className="text-center hover:shadow-lg transition-all duration-300 border-2 hover:border-primary/20">
              ...
              <CardContent>
                <CardDescription className="text-base leading-relaxed">
                  Track your progress with detailed metrics, identify weak areas, and get 
            ...
            <Card className="text-center hover:shadow-lg transition-all duration-300 border-2 hover:border-primary/20">
              ...
              <CardContent>
                <CardDescription className="text-base leading-relaxed">
                  Comprehensive question bank organized by all 5 SMLE domains with 
                  high-quality content from accredited medical references.
                </CardDescription>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">All SMLE domains included</p>
            </div>
            <div className="text-center">
              <div className="bg-primary/10 p-3 rounded-xl w-fit mx-auto mb-3">
          ...
          <Card className="bg-gradient-to-r from-primary/10 to-secondary/10 border-primary/20">
            <CardContent className="text-center py-12">
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                Join thousands of medical students who are already using Barshimha to ace their SMLE exams 
                with our smart, evidence-based learning approach.
              </p>
              ...
              <p className="text-sm text-muted-foreground mt-4">
                New users are automatically registered. The first user becomes an admin.
              </p>
            </CardContent>
          </Card>
        </div>
          ...
          <div className="text-center">
            <div className="flex items-center justify-center mb-4">
              <div className="bg-primary/10 p-2 rounded-lg">
                ...
                />
                <BookOpen className="h-6 w-6 text-primary" style={{ display: 'none' }} />
              </div>
